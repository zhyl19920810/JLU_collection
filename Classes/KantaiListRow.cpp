...
bool KantaiListRow::init(int position)
{
    bool bRet=false;
    ...
    do
    {
        ...
        menuItem=MenuItemSprite::create(item, Sprite::create("OrganizeMain/image 182.png"),item,CC_CALLBACK_1(KantaiListRow::exchangeCallback, this));
        menuItem->setPosition(Vec2(15, 2));
        menuItem->setScaleY(0.85);
        menuItem->setScaleX(0.95);
        lockIcon=MenuItemToggle::createWithCallback(CC_CALLBACK_1(KantaiListRow::lockCallback, this), MenuItemSprite::create(lock1,lock1),MenuItemSprite::create(lock2,lock2), NULL);
...
void KantaiListRow::update(Kantai* kantai)
{
    this->kantai=kantai;
...
KantaiListRow::KantaiListRow():kantai(NULL)
{
    
}

void KantaiListRow::exchangeCallback(cocos2d::Ref *pSender)
{
...
void KantaiListRow::lockCallback(cocos2d::Ref *pSender)
{

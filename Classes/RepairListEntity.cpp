...
RepairListEntity* RepairListEntity::create(cocos2d::Vec2 vec)
{
    RepairListEntity* pRet=new RepairListEntity;
...
bool RepairListEntity::init(cocos2d::Vec2 vec)
{
    bool bRet=false;
    do
    {
        CC_BREAK_IF(!ListEntity::init(vec));
